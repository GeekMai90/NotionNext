...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '麦先生说', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Anteey AI独立开发者 | 知识管理爱好者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://talk.anteey.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, Anteey, Antinet, Zettelkasten, 卡片盒笔记法', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '备案号 吉ICP备2025024553号', // 备案号 闽ICP备XXXXXX
  ...
  GREETING_WORDS:
    ...
    'Hi，我是 Anteey AI 独立开发者, Hi，我是知识管理爱好者,欢迎来到我的博客🎉',
